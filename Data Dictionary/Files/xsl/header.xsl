			...
			<body style="background-color:rgb(129,190,247);">
				<table style="background-color:rgb(129,190,247);" width="100%">
					<tr>
						...
						<td style="color:white;font-weight:bold;font-style:italic;" valign="bottom">
							<xsl:text><!--Welcome to the S1000D Hub--></xsl:text>
						</td>
						<td style="color:white;background-color:rgb(129,190,247);font-size:12pt;text-align:right;">
